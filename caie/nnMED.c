...
#define LearningRate 0.5     // most books suggest 0.3 as a starting point
#define Momentum     0.4    // must be >=0 and <1
...
#define NumNodes5    0       // note - there is no bias node in the output later
#define NumNodes6    0
...
#define NumOfRows    5       // largest layer - i.e., max number of rows in the network

// data files -----------------------------------------------
#define TrainFile    "p2trainMED.dat"  // file containing training data
#define TestFile     "p2testMED.dat"  // file containing testing data 
