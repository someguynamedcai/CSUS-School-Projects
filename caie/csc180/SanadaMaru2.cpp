...
void makeMove(string input, int side) {
	if (side == 1) {
		...
		if (input.at(1) == '0') translate = translate + '8';
		else if (input.at(1) == '1') translate = translate + '7';
		else if (input.at(1) == '2') translate = translate + '6';
		else if (input.at(1) == '3') translate = translate + '5';
		else if (input.at(1) == '4') translate = translate + '4';
		else if (input.at(1) == '5') translate = translate + '3';
		else if (input.at(1) == '6') translate = translate + '2';
		else if (input.at(1) == '7') translate = translate + '1';
		...
		if (input.at(3) == '0') translate = translate + '8';
		else if (input.at(3) == '1') translate = translate + '7';
		else if (input.at(3) == '2') translate = translate + '6';
		else if (input.at(3) == '3') translate = translate + '5';
		else if (input.at(3) == '4') translate = translate + '4';
		else if (input.at(3) == '5') translate = translate + '3';
		else if (input.at(3) == '6') translate = translate + '2';
		else if (input.at(3) == '7') translate = translate + '1';
...
int evaluate(int score, string input) {
	if ((input.at(3) - '0') == 1 && (input.at(2) - '0') == 3) return 5000;
	else if ((input.at(3) - '0') == 6 && (input.at(2) - '0') == 3) return -5000;
	else if (board[(input.at(3) - '0' - 1)][input.at(2) - '0' == 1]) return -100;
	else if (board[(input.at(3) - '0' - 1)][input.at(2) - '0' == 2]) return -150;
	else if (board[(input.at(3) - '0' - 1)][input.at(2) - '0' == 3]) return -100;
	else if (board[(input.at(3) - '0' - 1)][input.at(2) - '0' == 4]) return -150;
	else if (board[(input.at(3) - '0' + 1)][input.at(2) - '0' == 1]) return 100;
	else if (board[(input.at(3) - '0' + 1)][input.at(2) - '0' == 2]) return 150;
	else if (board[(input.at(3) - '0' + 1)][input.at(2) - '0' == 3]) return 100;
	else if (board[(input.at(3) - '0' + 1)][input.at(2) - '0' == 4]) return 150;
	else if ((input.at(3) - '0' == 6) && input.at(2) - '0' == 3) return -50;
	else if ((input.at(3) - '0' == 3) && input.at(2) - '0' == 2) return -50;
	else if ((input.at(3) - '0' == 3) && input.at(2) - '0' == 4) return -50;
	else return 0;
}

int max(int depth, string input, int side) { 
	int best = -20000,score;
	if (checkEnd(side) != -1) return (checkEnd(side));
	if (depth == maxdepth) return (evaluate(score, input));
	getmove(1);
	for (int v = 0; v < validmoves.size(); v++) {
		makeMove(validmoves[v], 0);
...
int min(int depth, string input, int side) { 
	int best = 20000, score;
	if (checkEnd(side) != -1) return (evaluate(score, input));
	if (depth == maxdepth) return (evaluate(score, input));
	getmove(0);
	for (int v = 0; v < validmoves.size(); v++) {
		makeMove(validmoves[v], 0);
...
void AIMove(string AIinput,int side) {
	...
	for (int v = 0; v < validmoves.size(); v++) {
		...
		score = max(depth+1, AIinput, side);
		if (score < best){
			best=score;
			AIinput = validmoves[v];
		}
