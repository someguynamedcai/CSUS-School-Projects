...
#define LearningRate 0.4     // most books suggest 0.3 as a starting point
#define Momentum     0.7  // must be >=0 and <1
...
// data files -----------------------------------------------
#define TrainFile    "sumA.dat"  // file containing training data
#define TestFile     "sumB.dat"  // file containing testing data 
